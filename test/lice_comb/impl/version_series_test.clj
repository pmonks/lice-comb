...
(deftest version-series-member?-tests
  ...
  (testing "Ids that are in a version series"
    ...
    (is (true? (version-series-member? "LZMA-SDK-9.22")))
    (is (true? (version-series-member? "LZMA-SDK-9.11-to-9.20")))
...
(deftest id->version-series-tests
  ...
  (testing "Ids in a version series - suffixes"
    ...
    (is (= "GPL"           (id->version-series "GPL-1.0+")))
    (is (= "GFDL"          (id->version-series "GFDL-1.3-no-invariants-or-later")))
    (is (= "CC-BY"         (id->version-series "CC-BY-1.0")))
    (is (= "CC-BY"         (id->version-series "CC-BY-2.5-AU")))
    (is (= "CC-BY"         (id->version-series "CC-BY-4.0")))
    (is (= "CC-BY-SA"      (id->version-series "CC-BY-SA-2.0-UK")))
    (is (= "CC-BY-SA"      (id->version-series "CC-BY-SA-2.1-JP")))
    (is (= "CC-BY-SA"      (id->version-series "CC-BY-SA-3.0-IGO")))
    (is (= "Artistic"      (id->version-series "Artistic-1.0")))
    (is (= "Artistic"      (id->version-series "Artistic-1.0-cl8")))
    (is (= "Artistic"      (id->version-series "Artistic-1.0-Perl")))
    ...
    (is (= "GCC-exception" (id->version-series "GCC-exception-2.0-note")))
